  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.card, { backgroundColor: colors.card, shadowColor: colors.shadow }]}>
        <Text style={[styles.cardTitle, { color: colors.text }]}>Plataforma de Cursos</Text>
        <Text style={[styles.cardText, { color: colors.text }]}>App para acompanhar progresso em cursos online</Text>
      </View>

      <View style={[styles.card, { backgroundColor: colors.card, shadowColor: colors.shadow }]}>
        <Text style={[styles.cardTitle, { color: colors.text }]}>Agenda de Serviços</Text>
        <Text style={[styles.cardText, { color: colors.text }]}>Plataforma para agendamento de serviços</Text>
      </View>
